...
function populateParameters(result) {var _result$brand =
  ...
  var parameters = {
    appId: "__UNI__D1F40BF",
    appName: "CareForChildren",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"CareForChildren","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
